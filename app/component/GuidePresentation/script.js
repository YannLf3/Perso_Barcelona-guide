  ...
  format(lang = "en") {
    const labels = {
      en: {
        eyebrow: "YOUR GUIDE",
        title:
          "My conception of a<span class='guide-presentation__title-accent'> tour</span>",
        desc: "A local guide brings the city to life through walking tours, small group moments and natural photo stops.",
        tags: ["SMALL GROUPS", "PHOTO STOPS", "SCHOOL GROUPS"],
      ...
      fr: {
        eyebrow: "VOTRE GUIDE",
        title:
          "Ma conception d'un <span class='guide-presentation__title-accent'>tour</span>",
        ...
        tags: ["PETITS GROUPES", "ARRÊTS PHOTO", "GROUPES SCOLAIRES"],
      ...
      es: {
        eyebrow: "LA TUA GUÍA",
        title:
          "Mi concepción de una <span class='guide-presentation__title-accent'>visita</span>",
        ...
        tags: ["GRUPOS PEQUEÑOS", "PARADAS FOTO", "GRUPOS ESCOLARES"],
      ...
      it: {
        eyebrow: "LA VOSTRA GUIDA",
        title:
          "Il mio progetto di un <span class='guide-presentation__title-accent'>giro</span>",
        desc: "Una guida locale dà vita alla città attraverso tour a piedi, momenti in piccoli gruppi e soste fotografiche naturali.",
        tags: ["PICCOLI GRUPPI", "SOSTE FOTO", "GRUPPI SCOLASTICI"],
